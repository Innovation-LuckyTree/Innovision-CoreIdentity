...
WORKDIR /src/CoreIdentity.API
RUN dotnet build CoreIdentity.API.csproj -c Debug -o /app/build

# Publish the application
FROM build AS publish
RUN dotnet publish CoreIdentity.API.csproj -c Debug -o /app/publish /p:UseAppHost=false
